...
public class StormManager : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        if (startingStorm && currentTimeSinceStartOfStorm <= maxTimeToSkipStorm)
        {
            InGamePopupsController.Instance.SetStormAlertTimer(maxTimeToSkipStorm - currentTimeSinceStartOfStorm);
        }
        else if (currentTimeSinceStartOfStorm > maxTimeToSkipStorm)
        {
    ...
    public void CallSkipStorm()
    {
        ...
        {
            Debug.LogWarning("SkipStorm() called but already skipped or invalid timing.");
            return;
        }
